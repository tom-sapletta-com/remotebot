...
info: ## Pokaż informacje o dostępie
	...
	@echo ""
	@echo "$(YELLOW)🎬 Live Monitor (Web Interface):$(NC)"
	@echo "   make live-monitor        - Uruchom web monitoring (http://localhost:5000)"
	@echo "   Features: Live VNC preview + step list + real-time updates"
	@echo ""
